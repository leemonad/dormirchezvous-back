...
Facade.getInstance().register(  "announces", 
                                ...
                                [new AuthGuard(), new CRSFGuard()],                     // put
...
app.delete  ('/announces/:id/:token', Facade.getInstance().create("announces")      ); // remove one
...
app.delete  ('/users/:id/:token'    , Facade.getInstance().create("users")          ); // remove one
...
app.delete  ('/events/:id/:token'   , Facade.getInstance().create("events")         ); // remove one
...
app.delete  ('/subscriptions/:id/:token'    , Facade.getInstance().create("subs")       ); // remove one
